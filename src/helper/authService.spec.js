...
describe("Basic logic", () => {
    ...
    afterEach(() => {
        localStorage.removeItem("pulpticket_token");
    });
    ...
    it("should set auth header if logged in successfuly", async () => {
        ...
        expect(localStorage.getItem("pulpticket_token")).toBe(expectedToken);
    });
    ...
    it("should logout user successfuly", async () => {
        ...
        expect(localStorage.getItem("pulpticket_token")).toBe(null);
    });
